...
2.1. Compare the left child node & the right child node
     Determine the smaller child
     (If there is no right child node, left child should be)
2.2. Compare the parent node to smaller node
2.3. Smaller node should be located in the parent node's position
...
3.1. buildHeap
3.2. Pick the Root element(which is located A[0])
3.3. Switch it to the last element (According to deletion of heap)
3.4. Use heapify to adjust the position of heap
3.5. Until all element is picked
